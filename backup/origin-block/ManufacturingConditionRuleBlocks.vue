...
.ed :deep(col:nth-child(3)) { width: 75%; } /* 槽體/測試點 */
.ed :deep(col:nth-child(4)) { width: 75%; } /* 槽體/測試點 */
.ed :deep(col:nth-child(5)) { width: 75%; } /* 槽體/測試點 */
.ed :deep(col:nth-child(6)) { width: 75%; } /* 槽體/測試點 */
.ed :deep(col:nth-child(7)) { width: 75%; } /* 槽體/測試點 */
.ed :deep(col:nth-child(8)) { width: 100%; } /* 槽體/測試點 */
